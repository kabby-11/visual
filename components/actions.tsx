...
// -> There are the action properties that are required for the dropdown
...
export function Actions({
  ...
  // ->using a hook to rename the modal(card)
  ...
  return (
    ...
    <DropdownMenu>
      ...
      >
        ...
        {/* -> I've made sure to use Delete button instead of a dropdown  */}
        <ConfirmModal
          header="Delete board?"
