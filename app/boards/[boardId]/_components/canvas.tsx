...
export const Canvas = ({ boardId }: CanvasProps) => {
  ...
  const [isGridVisible, setIsGridVisible] = useState(false);// Initializing the state with 'false'

  const toggleGrid = () => {
    setIsGridVisible((prev) =>!prev);//input in the function is x then the output is !x
  }
  ...
  return (
    <main className="h-full w-full relative bg-neutral-100 touch-none">
      ...
      {
        isGridVisible && (<GridPatternDashed />)
      }
      </div>
